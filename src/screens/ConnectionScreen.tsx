import { View, Text, TouchableOpacity, FlatList, SafeAreaView, ActivityIndicator, Platform } from 'react-native'
        ...
        return (
            <View style={connectionStyles.fileItem}>
                ...
                </View>
                {
                    item?.available ?
                        (
                            <TouchableOpacity style={connectionStyles.openButton}
